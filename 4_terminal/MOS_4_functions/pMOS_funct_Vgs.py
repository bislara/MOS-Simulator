...
def func(w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,s0,Po,No,NA,ND):	    
	try:
      	  #p=Vgs-Vfb+gm*Cox*(sqrt( Po*Phi_t*( e**(-s0/Phi_t )-1) +( NA-ND  )*s0 + No*Phi_t*( e**(s0/Phi_t )-1) ))-s0
...
def derivFunc( w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,s0,Po,No,NA,ND ):
    ...
    #f=Vgs-Vfb+gm*Cox*(sqrt( Po*e**(-Vds/Phi_t)*Phi_t*( e**(-t/Phi_t )-1) +( NA-ND  )*t + No*Phi_t*( e**(t/Phi_t )-1) ))-t
...
def func2(w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,sL,Po,No,NA,ND):	    
	try:
 	  ...
 	  #p=Vgs-Vfb+gm*Cox*(sqrt( Po*e**(-Vds/Phi_t)*Phi_t*( e**(-sL/Phi_t )-1) +( NA-ND  )*sL + No*Phi_t*( e**(sL/Phi_t )-1) ))-sL	 
	  return p
