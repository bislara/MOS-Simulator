...
def calculate_Id(w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,x0,Po,No,NA,ND):
	...
	Shi_s0=abs(newtonRaphson(w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,s0,Po,No,NA,ND))
	Shi_sL=abs(newtonRaphson2(w,l,mu,Vgs,Vfb,Vds,Cox,gm,Phi_t,Phi_F,sL,Po,No,NA,ND))
