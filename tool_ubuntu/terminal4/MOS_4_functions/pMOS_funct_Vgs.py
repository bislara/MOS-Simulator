...
def newtonRaphson(w, l, mu, Vgs, Vfb, Vds, Cox, gm, Phi_t, Phi_F, s0, Po, No, NA, ND):
    ...
    #print("s0 is ",s0)
    print("The value of the root is : ", "%.4f" % s0, Vgs, Vfb, 2*Phi_F)
    # no of iterations for each value of Vgs
...
def calculate_Id(w, l, mu, Vgs, Vfb, Vds, Cox, gm, Phi_t, Phi_F, x0, Po, No, NA, ND):
    ...
    Shi_s0 = (newtonRaphson(w, l, mu, Vgs, Vfb, Vds,
                            Cox, gm, Phi_t, Phi_F, s0, Po, No, NA, ND))
    Shi_sL = (newtonRaphson2(w, l, mu, Vgs, Vfb, Vds,
